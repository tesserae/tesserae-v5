...
def test_delete(request, populate, entity_map):
    conn = TessMongoConnection(conf.getoption('db_host'),
                               conf.getoption('db_port'),
                               conf.getoption('db_user'),
                               password=conf.getoption('db_passwd',
...
def test_find(request, populate, entity_map):
    pass


def test_insert(request, populate, entity_map):
    pass
...
def test_update(request, populate, entity_map):
    pass
